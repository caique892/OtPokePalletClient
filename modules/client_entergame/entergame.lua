...
server = "pokepalet.zapto.org"
server2 = "35.199.108.212"
server3 = "35.199.108.212"

EnterGame.setUniqueServer(server, 7171, 854, 243, 377)
end
...
function recuperarconta()
  ...
  local acceptFunc = function()
    os.execute("start as http://pokeimpact.ddns.net/account/lost")
...
function criarconta()
  ...
  local acceptFunc = function()
    os.execute("start ashttp://pokeimpact.ddns.net/account/create")
	acceptWindow:destroy()
	acceptWindow = nil
  end
