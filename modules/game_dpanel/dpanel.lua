function init()
	...
	connect(g_game, { onGameStart = function() dgTimeLeft:addAnchor(AnchorLeft, 'parent', AnchorLeft) dgTimeLeft:addAnchor(AnchorTop, 'parent', AnchorTop) dgTimeLeft:setMarginLeft(400) dgTimeLeft:setMarginTop(3) end})
	hide()
