...
function show()
	...
	--	else
			gameMapPanel:setMaxZoomOut(12) -- 11 -- 16
...
--	print(" (mode) "..mode)
	...
	if currentViewMode == 2 then	
		...
		bottomPanelWidth = gameBottomPanel:getWidth() -- Sam
		g_game.changeMapAwareRange(18, 14)
			
		gameBottomPanel:addAnchor(AnchorRight, 'gameRightPanel', AnchorLeft) -- Sam
        bottomSplitter:addAnchor(AnchorRight, 'gameRightPanel', AnchorLeft) -- Sam
	...
	elseif mode == 1 then
		...
		gameMapPanel:setLimitVisibleRange(true)
		gameMapPanel:setZoom(15) -- 11
		gameMapPanel:setVisibleDimension({ width = 33, height = 15 })
	elseif mode == 2 then
		local limit = limitedZoom and not g_game.isGM()
		gameMapPanel:setLimitVisibleRange(limit)
		gameMapPanel:setZoom(12) -- 15 -- 144
		gameMapPanel:setVisibleDimension({ width = 33, height = 15 })
		gameMapPanel:fill('parent')
		gameRootPanel:fill('parent')
		backGameLeftPanel:setImageColor('alpha')
		backGameRightPanel:setImageColor('alpha')
		gameLeftPanel:setMarginTop(modules.client_topmenu.getTopMenu():getHeight() - gameLeftPanel:getPaddingTop()) -- SL
        gameRightPanel:setMarginTop(modules.client_topmenu.getTopMenu():getHeight() - gameRightPanel:getPaddingTop()) -- SL
		gameRightPanel:setOn(true)
		gameMapPanel:setOn(true)
		gameBottomPanel:addAnchor(AnchorRight, 'gameRightPanel', AnchorRight) -- test
        gameBottomPanel:addAnchor(AnchorRight, 'gameRightPanel', AnchorLeft) -- test
		gameBottomPanel:setImageColor('#ffffff88')
		modules.client_topmenu.getTopMenu():setImageColor('#ffffff66')
		if not limit then
			g_game.changeMapAwareRange(35, 19)
		end
	end
