...
local recompenses = {
    ["E"] =
    {
        [1] = {recompenseList = {2160}, count = {5}},
        [2] = {recompenseList = {2160, 2160}, count = {5, 2}},
        [3] = {recompenseList = {2160}, count = {3}},
        [4] = {recompenseList = {2160}, count = {6}},
    }
}
...
function init()
    ...
    playertask_button = modules.client_topmenu.addRightGameToggleButton('taskButton', tr('Task'), 'task.png', exibir)
    playertask_button:setWidth(34)
...
function onReceivePlayerTasks(buffer)
    ...
    outfit:setMarginLeft(14)
    outfit:setMarginTop(5)
    outfit:setSize("42 42")
    ...
    name:setText(name_monster .. " - " .. count_player .. "/" .. count_monster .. " (" .. type .. ")")
    ...
    description:setFont("terminus-14px")
    ...
    recompenses_panel:setMarginTop(105)
    recompenses_panel:setMarginLeft(205)
